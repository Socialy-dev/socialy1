...
import { JournalistNotesDrawer } from "@/components/presse/JournalistNotesDrawer";
...
const RelationsPresse = () => {
  ...
  const [journalistForNotes, setJournalistForNotes] = useState<Journalist | null>(null);
  ...
  return (
    <div className="min-h-screen bg-background flex">
      ...
      <div className={cn("flex-1 flex flex-col min-h-screen content-transition", sidebarCollapsed ? "ml-20" : "ml-72")}>
              ...
              <div className="space-y-6">
                ...
                {isLoadingJournalists ? (
                  ...
                  <div className="bg-card rounded-2xl border border-border overflow-hidden">
                    <Table>
                      <TableHeader>
                          <TableRow className="bg-secondary/60 hover:bg-secondary/60 border-0">
                          ...
                          <TableHead className="font-semibold w-16 text-center">LinkedIn</TableHead>
                          <TableHead className="font-semibold">Email</TableHead>
                          <TableHead className="font-semibold w-16 text-center">Sélect.</TableHead>
                          <TableHead className="w-12" />
                        </TableRow>
                      </TableHeader>
                      <TableBody>
                        {filteredJournalists.map((journalist) => (
                          <TableRow
                            ...
                            className={cn(
                              "group cursor-pointer transition-all duration-200 border-0",
                          ...
                          >
                            <TableCell className="py-3">
                              <button
                                onClick={(e) => {
                                  e.stopPropagation();
                                  setJournalistForNotes(journalist);
                              ...
                              >
                                ...
                                {journalist.notes && !(journalist.enrichment_status === "pending" || journalist.enrichment_status === "processing") && (
                            ...
                            <TableCell className="py-3">
                              <span className="font-semibold text-foreground">{capitalizeFullName(journalist.name)}</span>
                            </TableCell>
                            ...
                            <TableCell className="py-3">
                              {journalist.media ? (
                                <button
                                  ...
                                  className={cn(
                                    "inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-gradient-to-r from-blue-500/15 to-indigo-500/15 text-blue-700 dark:text-blue-400 text-xs font-semibold border border-blue-500/20 transition-all",
                                ...
                                >
                                  ...
                                  <span className="max-w-[120px] truncate">{journalist.media}</span>
                            ...
                            <TableCell className="py-3">
                              {journalist.media_specialty ? (
                                <TooltipProvider>
                                  <Tooltip>
                                    <TooltipTrigger asChild>
                                      <span className="inline-flex items-center gap-1.5 px-2 py-1 rounded-lg bg-emerald-500/10 text-emerald-700 dark:text-emerald-400 text-xs font-medium max-w-[140px]">
                                        <Tag className="w-3 h-3 flex-shrink-0" />
                                        <span className="truncate">{journalist.media_specialty}</span>
                                      </span>
                                    </TooltipTrigger>
                                    <TooltipContent>
                                      <p>{journalist.media_specialty}</p>
                                    </TooltipContent>
                                  </Tooltip>
                                </TooltipProvider>
                              ) : (
                            ...
                            <TableCell className="py-3">
                              {journalist.job ? (
                                <TooltipProvider>
                                  <Tooltip>
                                    <TooltipTrigger asChild>
                                      <span className="inline-flex items-center gap-1.5 px-2 py-1 rounded-lg bg-purple-500/10 text-purple-700 dark:text-purple-400 text-xs font-medium max-w-[120px]">
                                        <Briefcase className="w-3 h-3 flex-shrink-0" />
                                        <span className="truncate">{journalist.job}</span>
                                      </span>
                                    </TooltipTrigger>
                                    <TooltipContent>
                                      <p>{journalist.job}</p>
                            ...
                            <TableCell className="py-3 text-center">
                              <div
                                className={cn(
                                  "w-6 h-6 rounded-lg border-2 flex items-center justify-center flex-shrink-0 transition-all mx-auto",
                                  journalist.selected
                  ...
                  <div className="bg-card rounded-2xl border border-border overflow-hidden">
                    <Table>
                      <TableHeader>
                        <TableRow className="bg-secondary/60 hover:bg-secondary/60 border-0">
                          <TableHead className="w-12" />
                          <TableHead className="font-semibold">Nom du communiqué</TableHead>
                      ...
                      <TableBody>
                        {communiques.map((communique) => {
                          ...
                          return (
                            <TableRow key={communique.id} className="group border-0">
                              <TableCell className="py-4">
                                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-primary/20 via-primary/10 to-transparent flex items-center justify-center">
                                  <FileText className="w-5 h-5 text-primary" />
                                </div>
                              </TableCell>

                              <TableCell className="py-4">
                                <span className="font-semibold text-foreground">{communique.name}</span>
                              </TableCell>
                                ...
                                <div className="flex items-center gap-2">
                                  {communique.pdf_url && (
                                    <a
                                      ...
                                      target="_blank"
                                      rel="noopener noreferrer"
                                      className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-red-500/10 text-red-600 hover:bg-red-500/20 transition-all text-xs font-semibold"
                                    >
                                  ...
                                  {communique.word_url && (
                                    <a
                                      ...
                                      target="_blank"
                                      rel="noopener noreferrer"
                                      className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-blue-500/10 text-blue-600 hover:bg-blue-500/20 transition-all text-xs font-semibold"
                                    >
                                  ...
                                  {communique.assets_link && (
                                    <a
                                      ...
                                      target="_blank"
                                      rel="noopener noreferrer"
                                      className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-purple-500/10 text-purple-600 hover:bg-purple-500/20 transition-all text-xs font-semibold"
                                    >
                                      <ExternalLink className="w-3.5 h-3.5" />
                                      Assets
                                    </a>
                                  )}
                                  {!communique.pdf_url && !communique.word_url && !communique.assets_link && (
                                    <span className="text-sm text-muted-foreground/50">—</span>
                                  )}
                                </div>
                              </TableCell>
        ...
        <JournalistNotesDrawer
          journalist={journalistForNotes}
          isOpen={showNotesDrawer}
          onClose={() => {
            setShowNotesDrawer(false);
            setJournalistForNotes(null);
          }}
          onSave={async (id, notes) => {
            await updateJournalistNotes(id, notes);
          }}
        />
