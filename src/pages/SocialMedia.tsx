...
const platformsConfig = {
  ...
  linkedin: {
    ...
    icon: Linkedin,
    color: "bg-[#0A66C2]",
    lightColor: "bg-blue-50 dark:bg-blue-950/50",
  ...
  instagram: {
    ...
    lightColor: "bg-pink-50 dark:bg-pink-950/50",
...
const SocialMedia = () => {
  ...
  const platforms = Object.entries(platformsConfig).filter(([key]) => key !== "global") as [Platform, typeof platformsConfig.linkedin][];
      ...
      >
        ...
        <main className="flex-1 p-6 overflow-y-auto">
          <div className="max-w-[1600px] mx-auto">
            ...
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Performances organiques sur les reseaux sociaux
                </p>
              </div>
            ...
            {/* Platform Selector - Compact toggle */}
            <div className="mb-6">
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <div className={cn(
                          ...
                          platformConfig.lightColor
                        )}>
                          <PlatformIcon className={cn("w-3.5 h-3.5", platformConfig.textColor)} />
                        </div>
                      </div>
              ...
              {filteredPosts.length === 0 && (
                <div className="text-center py-12 rounded-2xl bg-card border border-dashed border-border">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Aucun contenu trouve pour cette plateforme
                  </p>
                </div>
              )}
            </div>
