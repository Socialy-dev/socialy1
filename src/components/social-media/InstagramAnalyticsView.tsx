...
import { BarChart3, TrendingUp, Users, Hash, Layers, Instagram } from "lucide-react";

export const InstagramAnalyticsView = () => {
  const {
    loading,
    period,
    setPeriod,
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl font-bold text-foreground">Analyse Instagram</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="p-6 rounded-2xl bg-card border border-border/50">
          <ContentTypeBarChart data={contentTypeStats as any} />
        </div>
      </div>
      ...
      <div className="p-6 rounded-2xl bg-card border border-border/50">
        <PublishingRegularityChart 
          posts={filteredPosts.map(p => ({
            ...
            views_count: p.views_count || p.video_play_count,
