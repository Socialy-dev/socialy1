...
const projects: Project[] = [
  { name: "Nelsa web developement", manager: "Om prakash sao", dueDate: "May 25, 2023", status: "Completed", progress: 100 },
  { name: "Datascale AI app", manager: "Neilsan mando", dueDate: "Jun 20, 2023", status: "Delayed", progress: 35 },
  { name: "Media channel branding", manager: "Tiruvelly priya", dueDate: "July 13, 2023", status: "At risk", progress: 68 },
  { name: "Corlax iOS app developement", manager: "Matte hannery", dueDate: "Dec 20, 2023", status: "Completed", progress: 100 },
  { name: "Website builder developement", manager: "Sukumar rao", dueDate: "Mar 15, 2024", status: "On going", progress: 50 },
];
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex gap-2">
          {["Project", "Project manager", "Status"].map((filter) => (
            <button
              key={filter}
              className="flex items-center gap-1 px-3 py-1.5 text-sm text-foreground bg-background/50 rounded-lg hover:bg-background transition-colors"
            >
              {filter}
